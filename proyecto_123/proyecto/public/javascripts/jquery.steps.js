...
function renderPagination(wizard, options, state)
{
    if (options.enablePagination)
    {
        var pagination = "<{0} class=\"actions {1}\"><ul role=\"menu\" aria-label=\"{2}\">{3}</ul></{0}>",
            buttonTemplate = "<li><a href=\"#{0}\" id=\"close\" role=\"menuitem\">{1}</a></li>",
            buttonTemplate2 = "<li><a href=\"#{0}\" id=\"create\" role=\"menuitem\">{1}</a></li>",
            buttons = "";
        ...
        buttons += format(buttonTemplate2, "next", options.labels.next);
